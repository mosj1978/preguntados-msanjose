package com.github.sanchezih.api.questionados.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(getApiInfo())
				...
				.apis(RequestHandlerSelectors.basePackage("com.github.sanchezih.api.questionados.controller"))
				.paths(PathSelectors.any()).build();
	}

	private ApiInfo getApiInfo() {
		return new ApiInfo("Questionados API", // titulo
